...
- `core-beliefs.md` 원칙 위반 기능 추가
- Pay-to-Win 요소 (결제로 게임 유리해지는 것) 추가
- 테스트 없이 핵심 게임 로직 (충돌, 아이템, 볼 물리) 변경
...
스테이지 JSON 생성 시 추가로:
- `grid_cols: 7`, `grid_rows: 10` 고정
- 벽돌 수 20~70개
- 구간별 HP 범위 / 드롭률 준수 (`docs/product-specs/stage-system.md` 참고)

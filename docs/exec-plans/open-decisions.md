...
| ID | 항목 | 출처 | 비고 |
|----|------|------|------|
| ~~OD-003~~ | ~~스테이지 간 라이프 유지 vs 매 스테이지 3개 리셋~~ | stage-system.md | ✅ 완료 — 아래 참고 |
| OD-004 | 아이템 드롭 벽돌 출현 비율 확정 | brick-system.md | stage-system.md 기준 참고 |
| ~~OD-005~~ | ~~마법 분열구 분열 각도 (고정 vs 랜덤)~~ | item-system.md | ✅ 완료 — 아래 참고 |
| ~~OD-006~~ | ~~마법 화염포 자동발사 간격~~ | item-system.md | ✅ 완료 — 아래 참고 |
| ~~OD-007~~ | ~~20회 타격 수치 밸런싱~~ | item-system.md | ✅ 완료 — 아래 참고 |
...
| ~~OD-010~~ | ~~마법 화염포 튜토리얼~~ | new-user-onboarding.md | ✅ 완료 — 아래 참고 |
...
| OD-006 | 마법 화염포 자동발사 간격 | **0.5초 고정** | Phase 2 |
| OD-010 | 마법 화염포 튜토리얼 | **획득 시 HUD 토스트 메시지** | Phase 2 |
